...
CREATE USER khanhlinh
PASSWORD = 'LinhKhanh1608'
DEFAULT_ROLE = "DE_ROLE";

GRANT ROLE DE_ROLE TO USER khanhlinh;
GRANT ROLE ACCOUNTADMIN TO USER khanhlinh;

GRANT all ON WAREHOUSE COMPUTE_WH TO ROLE DE_ROLE;
GRANT ALL ON DATABASE GAMMINGGROUP6 TO ROLE DE_ROLE;
GRANT ALL ON ALL SCHEMAS IN DATABASE GAMMINGGROUP6 TO ROLE DE_ROLE;
GRANT ALL ON ALL TABLES IN DATABASE GAMMINGGROUP6 TO ROLE DE_ROLE;
GRANT ALL ON TABLE GAMMINGGROUP6.PUBLIC.DIM_USER TO DE_ROLE;
